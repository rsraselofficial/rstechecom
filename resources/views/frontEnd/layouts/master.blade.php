...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Ummah Host BD" />
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved | <span style="color: white;">Website Designed by: <a href="https://mobarokhussain.com/"><span style="color: white;">Mobarok Hussain</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
